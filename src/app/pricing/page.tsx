...
const FEATURE_CATEGORIES = [
  ...
  },
  {
    ...
    features: [
      ...
      { name: 'Analytics dashboard', free: false, starter: false, pro: 'Basic', brokerage: 'Advanced' },
      { name: 'Priority AI generation', free: false, starter: false, pro: true, brokerage: true },
            ...
            <div className="space-y-4">
              {[
                ...
                },
                {
                  ...
                  a: 'Yes. Cancel any time from your dashboard. You\'ll keep access until the end of your billing period. No cancellation fees.',
                },
                {
                ...
                },
                {
                  ...
                  a: 'Pro includes 3 seats. Brokerage supports up to 25 agents under one account with an admin dashboard. Enterprise is unlimited.',
                },
                {
                  q: 'Is my listing data secure?',
                  a: 'Yes. We use encrypted connections to pull MLS data, store nothing longer than necessary, and never sell your data. We are GDPR and CCPA compliant.',
                },
                {
                  q: 'What happens if I exceed my campaign limit?',
                  a: 'You\'ll be notified and prompted to upgrade. We never auto-charge overages — you stay in control.',
                },
              ].map((faq) => (
