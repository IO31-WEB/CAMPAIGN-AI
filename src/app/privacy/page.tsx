      ...
      <div className="pt-28 pb-24 px-4 sm:px-6 lg:px-8 max-w-3xl mx-auto">
        ...
        <div className="prose prose-slate max-w-none space-y-8 text-sm leading-relaxed text-slate-700">
          {[
            ...
            { title: '3. MLS Data', body: 'Listing data is fetched in real time from Repliers and cached temporarily to generate your campaign. We do not store listing data beyond what is needed for your campaign history. Cached listing data expires after 30 days.' },
